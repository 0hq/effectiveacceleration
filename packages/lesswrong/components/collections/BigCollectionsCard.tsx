...
const BigCollectionsCard = ({
  ...
  console.log("BigCollectionsCard rendering", collection, url, classes);
...
const BigCollectionsCardComponent = registerComponent("BigCollectionsCard", BigCollectionsCard, { styles });
